...
public class OnPoadaingActivity extends AppCompatActivity {
    ...
    private void listenr() {
        btn_next.setOnClickListener(view -> {
            switch (click) {
                case 0:
                    setData(R.drawable.first, R.drawable.group, getString(R.string.text_1));
                    click = 1;
                    break;
                case 1:
                    setData(R.drawable.secand, R.drawable.group_2, getString(R.string.text_2));
                    click = 2;
                    break;
                case 2:
                    setData(R.drawable.third, R.drawable.group_3, getString(R.string.text_3));
                    click = 3;
                    break;
                case 3:
                    startMainActivity();
